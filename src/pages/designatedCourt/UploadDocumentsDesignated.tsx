            ...
            <div>
                    ...
                    <div className="rounded-t-lg bg-[#EEF7EB] flex justify-between items-center h-16 text-gilroy-bold mb-4">
                      ...
                      <div className="flex p-7 space-x-2 ">
                        ...
                        <div>
                        <h1 className="text-sm font-normal text-gilroy-medium text-[#1D1D1B]">Upload Document </h1>
                    ...
                    <span className='text-red-500'>*</span>Office Order / Any other supporting document for appointment of Nodal Officer.
                          </h1>
                  </div>
