...
const Header = () => {
  ...
  key = key?.split(" ")?.map((k) => k.slice(0,1).toUpperCase() + k.slice(1).toLowerCase())?.join(' ');
  ...
  return (
    <>
      <div className="flex items-center justify-between p-4 mt-2 pb-6 flex-col sm:flex-row border-b border-[#E6E6E6]">
        <div className="">
          {key && <div className="h-8 px-2 rounded-[5px] border border-[#54B749] flex items-center justify-center">
