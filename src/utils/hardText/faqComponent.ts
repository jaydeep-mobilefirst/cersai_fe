export const faqData = {
    A: {
      title: "A) About CKYC",
      items: [
        { question: "a1. What is Central KYC Registry?", answer: "Central KYC Registry is a centralized repository of KYC records of customers in the financial sector with uniform KYC norms and inter-usability of the KYC records across the sector with an objective to reduce the burden of producing KYC documents and getting those verified every time when the customer creates a new relationship with a financial entity." },
        {
          question: "What are the salient features of Central KYC Registry?",
...
"API’s for search and download allow for real time account opening for CKYC compliant customers."],
        },
        {
          ...
          answer: "Central KYC application can be accessed by authorised institutions or other notified institutions under the Prevention of Money Laundering Act or rules framed by the Government of India or any Regulator (RBI, SEBI, IRDA, and PFRDA) there under.",
        },
        {
          question:
          ...
          answer: ["The PMLA states as per rule (9) (I) (1):","Subject to the provisions of sub-rule (1) of the Prevention of Money-laundering Act, 2002, every reporting entity shall within three days after the commencement of an account-based relationship with a client, file the electronic copy of the client´s KYC records with the Central KYC Records Registry.",
    ...
    B: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: ["Financial Institutions (FI) have to register at https://www.ckycindia.in/admin/FIRegistration.action?parameter=START",
...
"Kindly note that the live environment and test environment are independent of each other and will require separate registration. The Institution code and login credentials generated in the test environment are NOT to be used in the live environment. The pre-filled form generated while registering on the live environment has to be sent to CERSAI along with other required documents."],
        ...
        },
        {
          ...
          answer: ["An active Institutional admin (IA) can use ‘Institution Admin Request’ option under User Management to initiate a change request with CERSAI to deactivate an existing IA and create a new IA in their place. You may also initiate requests to update IA details using this functionality.",
      ...
      items: [
        {
          ...
          answer: "There needs to be internet connectivity with bandwidth of minimum 512 kbps and a scanner with the stipulated specifications.",
        },
        {
          question: "How can we connect to CKYC system after registration?",
          answer: "Please refer connectivity guidelines in download section https://www.ckycindia.in/ckyc/assets/doc/Connectivity-Guidelines-2.pdf",
        },
        {
          question: "c3. What are different channels for Search, Upload, Download and Update?",
          answer: ["Webpage based Search, Upload, Download and Update of records",
