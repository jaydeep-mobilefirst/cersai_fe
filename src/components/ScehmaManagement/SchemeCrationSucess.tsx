...
// import tickCircle from "../../assets/images/tickCircleBlue.svg";
...
// const SchemeCreationSuccess: React.FC<SuccessProps> = ({
//   closePopup,
//   SuccessPopup,
// }) => {
//   return (
...
//           alignItems: "center",
//           justifyContent: "center",
//           minHeight: "100vh", // Ensure the modal covers the entire viewport
//         }}
//       >
...
// export default SchemeCreationSuccess;
...
const SchemeCreationSuccess: React.FC<ApproveProps> = ({
  closePopup,
  SuccessPopup,
}) => {
  return (
