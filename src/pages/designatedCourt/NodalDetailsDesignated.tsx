...
// const NodalDetailsDesignated = (props: Props) => {
//   const {
//     register,
//     handleSubmit,
//     formState: { errors },
...
//               <label
//                 htmlFor="Dsc"
//                 className="block text-gray-700 text-sm font-bold mb-2 mt-7"
//               ></label>
...
//           </button>
//         </div> */}
//         <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center space-y-4 sm:space-y-0 lg:mt-56 md:mt-56 mt-4 ">
