      ...
      faqPageData: {
        ...
        ckycQuestions: [
          [
            {
              name: "question",
              text: "a1. What is Central KYC Registry?",
            },
            {
              name: "answer",
          ...
          [
            {
              name: "question",
              text: "What are the salient features of Central KYC Registry?",
          ...
          [
            {
              name: "question",
              text: "Who can get access to Central KYC application?",
              
            },
            {
              name: "answer",
              text: "Central KYC application can be accessed by authorised institutions or other notified institutions under the Prevention of Money Laundering Act or rules framed by the Government of India or any Regulator (RBI, SEBI, IRDA, and PFRDA) there under.",
          ...
          [
            {
              name: "question",
              text: "Which entities are required to upload / search / download / update KYC records as per the Prevention of Money Laundering Act (PMLA)?",
        ...
        reportingEntityQuestions: [
          [
            {
              name: "question",
              text: "What is the process for a financial institution to get registered with Central KYC Registry for registration references from 100000 onwards?",
            },
            {
              name: "answer",
              text: [
          ...
          [
            {
              name: "question",
              text: "What is the process for a financial institution to get registered with Central KYC Registry for registration references from 300000 onwards?",
              
            },
            {
              name: "answer",
              text: ["Financial Institutions (FI) have to register at https://www.ckycindia.in/admin/FIRegistration.action?parameter=START",
          ...
          [
            {
              name: "question",
              text: "What is the process for modifying or changing the institution details and admin / nodal officer details in the CKYC system after registration is completed.",
              
            },
            {
              name: "answer",
              text: ["An active Institutional admin (IA) can use ‘Institution Admin Request’ option under User Management to initiate a change request with CERSAI to deactivate an existing IA and create a new IA in their place. You may also initiate requests to update IA details using this functionality.",
        ...
        connectivityQueryQuestions: [
          [
            {
              name: "question",
              text: "What kind of infrastructure would be required at the financial institution for accessing Central KYC application?",
            },
            {
              name: "answer",
              text: "There needs to be internet connectivity with bandwidth of minimum 512 kbps and a scanner with the stipulated specifications.",
          ...
          [
            {
              name: "question",
              text: "How can we connect to CKYC system after registration?",
              
            },
            {
              name: "answer",
              text: "Please refer connectivity guidelines in download section https://www.ckycindia.in/ckyc/assets/doc/Connectivity-Guidelines-2.pdf",
            },
          ],
          ...
          [
            {
              name: "question",
              text: "c3. What are different channels for Search, Upload, Download and Update?",
              
            },
            {
              name: "answer",
              text: ["Webpage based Search, Upload, Download and Update of records",
