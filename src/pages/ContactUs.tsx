...
const ContactUs: React.FC = () => {
  ...
  const { contactUsPageDataa, setcontactUsPageData } = useContactUsStore(
    (state) => state
  );
          ...
          <div className="md:my-[56px] my-[12px] md:px-[56px] px-[16px] w-full">
            ...
            <div className="md:flex md:flex-row md:gap-x-28 xl:gap-x-52 flex flex-col">
              <div className="mb-6">
                <h2 className="md:text-base text-[14px] font-bold text-gilroy-semibold">
                  {
                    contactUsPageDataa?.ckycRegistrationQueriesHeading?.[0]
                      ?.text
                  }
                </h2>
                <p className="md:text-base text-[14px] font-normal text-gilroy-medium mt-2">
                  ...
                  {
                    contactUsPageDataa?.ckycRegistrationQueriesDetails?.[0]
                      ?.text
                  }
                </p>
                <p className="md:text-base text-[14px] font-normal text-gilroy-medium">
                  {contactUsPageDataa?.phoneNumberLabel?.[0]?.text}:{" "}
                  {
                    contactUsPageDataa?.ckycRegistrationQueriesDetails?.[1]
                      ?.text
                  }
                </p>
                <p className="md:text-base text-[14px] font-normal text-gilroy-medium">
                  {contactUsPageDataa?.emailLabel?.[0]?.text}:{" "}
                  {
                    contactUsPageDataa?.ckycRegistrationQueriesDetails?.[2]
                      ?.text
                  }
                </p>
              </div>
            ...
            <div className="mb-6">
              ...
              <p className="md:text-base text-[14px] font-normal text-gilroy-medium mt-2">
                {contactUsPageDataa?.addressLabel?.[0]?.text}:{" "}
                {contactUsPageDataa?.addressDetails?.[0]?.text}
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-blue-500 underline">
                <Link target={"_blank"} to={contactUsPageDataa?.residentailProcessDetails?.[1]?.link}>
                  {" "}
                  {contactUsPageDataa?.residentailProcessDetails?.[1]?.text}
                </Link>
              </p>
