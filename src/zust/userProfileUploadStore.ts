...
interface ProfileRegulatorState {
  ...
  uploadDocument: () => Promise<void>; // Async function to update entity details
}

const userProfileUploadStore = create<ProfileRegulatorState>((set, get) => ({
...
export default userProfileUploadStore;
