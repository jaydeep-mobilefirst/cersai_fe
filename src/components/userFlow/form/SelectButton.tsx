...
const SelectButton = ({ setOption, options, placeholder, searchInputOnchange, searchInputValue, selectedOption }: Props) => {
    ...
    return (
        <>
            ...
            {arrowDirectionToggle && (
                ...
                >
                    {searchInputOnchange && <div className="relative p-2">
                        <svg
