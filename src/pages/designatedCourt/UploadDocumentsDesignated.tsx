            ...
            {documentData?.length > 0 ? (
              <div className=" p-4 lg:p-[48px]">
                ...
                <h1 className="text-[14px] md:text-sm font-normal text-gilroy-medium text-[#666666]">
                  <span className="text-red-500">*</span>Office Order / any
                  other supporting document for appointment of Nodal Officer
                </h1>
              </div>
            ) : (
            ...
            {documentData?.length > 0 && (
              ...
              >
                <div
                  ...
                  onClick={() =>
                    Navigate("/designated/court/designateddetails")
                  }
                >
                  <svg
