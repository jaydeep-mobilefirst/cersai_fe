        ...
        <div className="fixed top-0 right-0 bottom-0 left-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
          <div className="bg-white rounded-lg p-8 w-[90%] max-w-[500px] relative">
            ...
            <div className="text-center mb-4">
              ...
              />
              <p className="text-gilroy-medium text-gray-700 mb-2 text-lg">
                Are You Sure To Delete
              </p>
              <p className="text-gilroy-medium text-[#1c468e] mb-4 text-lg">
            ...
            <div className="flex justify-center">
              <button
                onClick={toggleDeletePopup}
                className="bg-transparent border-[#1c468e] border w-[45%] md:w-[224px] rounded-xl px-4 md:px-10 py-3 text-[#1c468e] text-gilroy-medium text-sm mr-4 mb-2 md:mb-0"
              >
                Cancel
              </button>
              <button
